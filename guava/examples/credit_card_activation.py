...
class CreditCardActivationController(guava.CallController):
    def __init__(self):
        super().__init__()
        self.intent_recognizer = IntentRecognizer(["activate credit card", "anything else"])
        self.set_persona(
