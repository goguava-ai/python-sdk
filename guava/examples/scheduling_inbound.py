...
class SchedulingController(guava.CallController):
    def __init__(self):
        ...
        self.set_persona(organization_name="Bright Smile Dental", agent_name="Grace")
        self.set_task(
            checklist=[
                guava.Say(
                    "Hello this is Grace from Bridge Smile Dental. I'm here to help you schedule a dental appointment."
                ),
                guava.Field(
                    key="caller_name",
                    field_type="text",
