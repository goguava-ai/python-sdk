...
def get_phone_number() -> str:
    """
    For use in Guava examples. Returns a phone number if one is present in the user's account, otherwise prints
...
PROPERTY_INSURANCE_POLICY = """HARPER VALLEY PROPERTY INSURANCE
...
DENTAL_IMPLANT_INFO = """
Dental Implant Surgery Appointment
Virtual Agent Reference Guide

1. Appointment Overview
Procedure: Dental Implant Surgery
Dentist: Dr. Benson
Office Location:
7421 Wilshire Blvd, Suite 410, Los Angeles, CA 90048
General Office Phone Line: 212-743-8729

Purpose of the Virtual Agent:
- Remind the patient of their upcoming implant surgery
- Provide pre-op and post-op instructions
- Answer common informational questions
- Assist with appointment changes such as rescheduling or cancellations when requested

2. Eating & Drinking Instructions (Pre-Surgery)

If Sedation or General Anesthesia Is Planned:
- Do NOT eat or drink anything for at least 8 hours before the appointment
- This includes water, coffee, tea, gum, and mints
- Small sips of water may be allowed for essential medications only, if approved

If Local Anesthesia Only (No Sedation):
- A light meal may be eaten up to 2 hours before the appointment
- Avoid heavy, greasy, or spicy foods

If the patient is unsure which type of anesthesia they are receiving, the virtual agent may explain the options and recommend confirming details with the office if needed.

3. Anesthesia & Sedation Information

Dental implant surgery does not always require general anesthesia.
...
- If any sedation is used, the patient must have an adult escort
- The patient cannot drive themselves home
- Rideshare services are not allowed unless accompanied by a responsible adult

4. Medications (Pre- & Post-Surgery)

Before surgery:
- Continue regular medications unless instructed otherwise
- Avoid aspirin, NSAIDs (Advil, Aleve), and blood thinners unless cleared by Dr. Benson

After surgery:
- Prescriptions may include antibiotics, pain medication, and antibacterial mouth rinse
- Medications should be taken exactly as prescribed

Medication-specific or medical clearance questions should be escalated to the office at 212-743-8729.

5. Eating & Drinking After Surgery
...
First 24–72 hours:
- Eat soft foods such as yogurt, mashed potatoes, smoothies (no straw), soup (lukewarm), and scrambled eggs

Avoid:
- Crunchy foods
- Chewing on the implant side
- Straws for at least 7 days
- Alcohol for 48–72 hours

6. Post-Op Care Instructions

Swelling & discomfort:
- Swelling peaks at 48–72 hours
- Use ice packs 20 minutes on and 20 minutes off for the first 24 hours

Oral hygiene:
- Do NOT brush the surgical area for the first 24 hours
- Resume gentle brushing afterward
- Use prescribed mouth rinse as directed
- Do not spit forcefully or rinse aggressively for 24 hours

Bleeding:
- Minor bleeding is normal
- Bite gently on gauze for 30–60 minutes if needed

7. Activity Restrictions
- Rest the day of surgery
- Avoid heavy lifting and strenuous exercise for at least 72 hours
- Keep head elevated when resting

8. Parking & Arrival Information
- Street parking available along Wilshire Blvd and nearby side streets
- Paid parking garage located one block east of the office
- Arrive 15–20 minutes early

9. Insurance Information
- Dental implant surgery is often partially covered or not covered by insurance
- Coverage varies by plan
- Insurance estimates and out-of-pocket expectations are typically discussed prior to surgery

The virtual agent can provide high-level insurance guidance but cannot guarantee coverage or modify insurance estimates.
For detailed insurance or billing issues, patients should call 212-743-8729.
...
- Debit cards
- HSA / FSA cards
- Third-party financing if pre-approved

Payment balances and detailed financing agreements are handled by the office.

11. When to Contact the Office Directly
Patients should be directed to call the office at 212-743-8729 if they experience:
- Severe or worsening pain after 3 days
- Excessive bleeding
- Fever over 101°F
- Signs of infection such as pus, severe swelling, or redness
- Questions requiring direct medical evaluation or billing resolution

12. What the Virtual Agent CAN Help With
- Appointment reminders
- Rescheduling or canceling appointments
- Pre- and post-op instructions
- Fasting and eating guidelines
- High-level anesthesia explanations
- Parking and arrival info
- General implant surgery expectations

13. What the Virtual Agent Should Escalate
- Medical clearance decisions
- Medication changes outside standard instructions
- Detailed insurance disputes
- Billing corrections or refunds

For these cases, provide the office phone number: 212-743-8729.

14. Closing Script Suggestion
If you have any additional questions, need to make changes to your appointment,
or would like further assistance, I’m happy to help.
For medical or billing matters requiring direct staff support,
you may also contact our office at 212-743-8729.
"""

FURNITURE_RETAILER_QA = """
